...
class Language {
  ...
  public static function fromPredefined($langcode) {
    include_once \Drupal::root() . '/includes/iso.inc';
    ...
    $instance->direction = isset($predefined[2]) ? $predefined[2] : \Drupal\Core\Language\Language::\Drupal\Core\Language\Language::LANGUAGE_LTR;
    return $instance;
  }
