...
// variable_set(XAUTOLOAD_VARNAME_CACHE_LAZY, $cache_lazy);
  ...
  protected function assertModuleDisabled($module) {
    $this->assertFalse(\Drupal::moduleHandler()->moduleExists($module), "Module $module is disabled.");
  }
  ...
  protected function assertModuleEnabled($module) {
    $this->assertTrue(\Drupal::moduleHandler()->moduleExists($module), "Module $module is enabled.");
  }
